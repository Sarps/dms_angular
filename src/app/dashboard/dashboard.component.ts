...
const chartData: any = require('../shared/data/chartist.json');
...
export class DashboardComponent {
    ...
    lineArea: Chart = {
        type: 'Line',
        data: chartData['lineAreaDashboard'],
        options: {
            low: 0,
            showArea: true,
            fullWidth: true,
    ...
    lineChart: Chart = {
        type: 'Line', data: chartData['LineDashboard'],
        options: {
            axisX: {
                showGrid: false
            },
    ...
    BarChart: Chart = {
        type: 'Bar', data: chartData['DashboardBar'], options: {
            axisX: {
                showGrid: false,
            },
            axisY: {
    ...
    WidgetlineChart: Chart = {
        type: 'Line', data: chartData['WidgetlineChart'],
        options: {
            axisX: {
                showGrid: true,
                showLabel: false,
