...
export const ROUTES: RouteInfo[] = [
    ...
    },
    {
        ...
        submenu: [
            { path: '/inventory/list', title: 'Stock File', icon: 'fa fa-building-o', class: '', badge: '', badgeClass: 'badge badge-pill badge-danger float-right mr-1 mt-1', submenu: [] },
    ...
    },
    {
        ...
        submenu: [
            ...
            { path: '/servicing/jobs/list', title: 'Job Board', icon: 'ft-tag', class: '', badge: '', badgeClass: '', submenu: [] },
    ...
    },
    {
        path: '', title: 'Management', icon: 'ft-users', class: 'has-sub', badge: '', badgeClass: '', submenu: [
            ...
            { path: '/maintenance', title: 'Part Order Approvals', icon: 'ft-check-circle', class: '', badge: '*', badgeClass: 'badge badge-pill badge-danger float-right mr-1 mt-1', submenu: [] },
            { path: '/maintenance', title: 'Part Sales Figures', icon: 'ft-airplay', class: '', badge: '', badgeClass: 'badge badge-pill badge-danger float-right mr-1 mt-1', submenu: [] },
            { path: '/maintenance', title: 'Service Intake', icon: 'ft-clipboard', class: '', badge: '', badgeClass: 'badge badge-pill badge-danger float-right mr-1 mt-1', submenu: [] },
            { path: '/maintenance', title: 'Service Sale Figures', icon: 'ft-file-text', class: '', badge: '', badgeClass: 'badge badge-pill badge-danger float-right mr-1 mt-1', submenu: [] },
            { path: '/maintenance', title: 'Periodic Profit & Loss', icon: 'ft-pie-chart', class: '', badge: '', badgeClass: 'badge badge-pill badge-danger float-right mr-1 mt-1', submenu: [] },
            { path: '/management/company/edit', title: 'Company Information', icon: 'ft-slack', class: '', badge: '', badgeClass: '', submenu: [] },
            { path: '/maintenance', title: 'Sales Group Setup', icon: 'ft-upload-cloud', class: '', badge: '', badgeClass: 'badge badge-pill badge-danger float-right mr-1 mt-1', submenu: [] },
